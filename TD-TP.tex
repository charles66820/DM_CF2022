    ...
    *a = (*a) ^ (*b);
    ...
    \begin{solutionorbox}
      \begin{align*}
        ...
        \equiv                    & ~\top
      \end{align*}
      Tripplet de Hoare = $\{T\}swap\{\psi\}$ avec $\psi \equiv \psi_1 \wedge \psi_2$\\
      $\psi_1 = (*a == \old(*b))$\\
      $\psi_2 = (*b == \old(*a))$
    \end{solutionorbox}
 ...
 unsigned int n)
{
    ...
    \begin{solutionorbox}
      ...
      \begin{align*}
        \WLP(10-14,I_5) \equiv & ~\breaktowidth{10cm}{\WLP(10, \WLP(11, \WLP(12, \WLP(13, \WLP(14, I_5)))))}\\
        \equiv               & ~\breaktowidth{10cm}{\WLP(10, \WLP(11, \WLP(12, \WLP(13, \forall k; i <= k <= j-1 \Rightarrow t[k] == \old(t[k])))))}\\
        \equiv               & ~\breaktowidth{10cm}{\WLP(10, \WLP(11, \WLP(12, (\forall k; i+1 <= k <= j-1 \Rightarrow t[k] == \old(t[k])) \Rightarrow I'_5)))}\\
        \equiv               & ~\breaktowidth{10cm}{\WLP(10, \WLP(11, I'_5))}\\
        \equiv               & ~\breaktowidth{10cm}{\WLP(10, I'_5)}\\
        \equiv               & ~\breaktowidth{10cm}{I'_5 = (\forall k; i+1 <= k <= j-1 \Rightarrow t[k] == \old(t[k]))}
      \end{align*}
