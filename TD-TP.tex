 ...
 unsigned int n)
{
    ...
    \begin{solutionorbox}
      ...
      \begin{align*}
        \WLP(10-14,I_2) \equiv & ~\breaktowidth{10cm}{\WLP(10, \WLP(11, \WLP(12, \WLP(13, \WLP(14, I_3)))))}\\
      ...
      or grâce à l'invariant $I_4$ et comme on a $i<j$, alors dans la portion du tableau entre la valeur initiale de $i$ et $i+1$, on a
