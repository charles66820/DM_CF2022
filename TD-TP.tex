...
void initPerm(int *P, unsigned int n) {
    ...
    */
    ...
    \begin{solutionorbox}
        ...
        Or comme on sait que pour qu'il n'y ait pas d'erreur d'exécution(car un tableau est de taille $>=0$), 
        et que i est initialisé à 0 (ligne 6). Notre boucle incrémente i de 1 tant qu'il est plus petit n. A la sortie de la boucle
        ...
        On fait le calcul :
        \begin{align*}
            \WLP(15-16, n-i < at(n-i,10)) \equiv & ~\breaktowidth{7cm}{j-(i+1) < at(n-i,10)}\\
